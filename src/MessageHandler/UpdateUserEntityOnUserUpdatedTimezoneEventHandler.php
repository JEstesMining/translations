...
final class UpdateUserEntityOnUserUpdatedTimezoneEventHandler implements EventHandlerInterface
{
    use HandleTrait;
    ...
    public function __invoke(UserUpdatedTimezoneEvent $message)
    {
        ...
        $entity->setTimezone($message->getPayloadValue('timezone'));
