...
final class UpdateUserEntityOnUserUpdatedLocaleEventHandler implements EventHandlerInterface
{
    use HandleTrait;
    ...
    public function __invoke(UserUpdatedLocaleEvent $message)
    {
        ...
        $entity->setLocale($message->getPayloadValue('locale'));
